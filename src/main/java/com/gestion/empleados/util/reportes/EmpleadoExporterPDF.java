...
public class EmpleadoExporterPDF {
	...
	private void escribirCabeceraDeLaTabla(PdfPTable tabla) {
		...
		celda.setPhrase(new Phrase("Proyecto", fuente));
		tabla.addCell(celda);
		
		celda.setPhrase(new Phrase("Tarea", fuente));
		tabla.addCell(celda);
	}
	...
	private void escribirDatosDeLaTabla(PdfPTable tabla) {
		for (Empleado empleado : listaEmpleados) {
			...
			tabla.addCell(String.valueOf(empleado.getProyecto()));
			tabla.addCell(String.valueOf(empleado.getTarea()));
		}
	}
